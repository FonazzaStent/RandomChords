"""Random Chords 2.1.6 - Generate random chords.
Copyright (C) 2023-2026  SymbolForm
...
def create_app_window():
    ...
    chord_display_label.configure(text="Chord",anchor="w", justify="left",font=("Arial",12),wrap="350")
    #scales display
    global scales_display
    global scales_display_label
    scales_display=Combobox(top)
    scales_display.place(x=25,y=280,height=25,width=420)
    ...
    scales_display_label.place(x=25,y=305,width=420)
    ...
    history_display.place(x=25, y=340, height=160, width=405)
    scroll_1=tk.Scrollbar (top)
    scroll_1.place(x=440, y=340, height=160, anchor='n')
...
def name_chord():
    ...
    chordname_string=[]
    chordname_string=musicpy.alg.detect(chord,
...
def aboutbox():
    ...
    url_title.configure(text="Random Chords 2.1.6", font=("Arial",15))
...
def helpbox():
    ...
    textbox1 = tk.Text(helpbox)
    textbox1.place(x=20, y=20, height=470, width=400)
    scroll_2=tk.Scrollbar (helpbox)
