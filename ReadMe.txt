...
second note is the lowest note of the chord, the other notes are above the lowest note, ending possibly on higher octaves.

At the prompt input Enter to generate a new chord, "q" to quit the program. Just closing the terminal window will also close the program.

New in this version:

- Improved algorithm
- Modified default parameters to 4 note chords with no clashes and no repeated notes allowed